...
export function AppCatFab({ accessibilityLabel, disabled = false, onPress, style }: AppCatFabProps) {
    ...
    >
      <Svg width={62} height={50} viewBox="0 0 1280 982" style={styles.catShape}>
        <G transform="translate(0,982) scale(0.1,-0.1)">
          <Path d={CAT_FACE_PATH} fill={colors.primary} />
        </G>
      </Svg>
      <MaterialCommunityIcons name="plus" size={27} color={colors.onPrimary} style={styles.plus} />
    </Pressable>
  );
}
